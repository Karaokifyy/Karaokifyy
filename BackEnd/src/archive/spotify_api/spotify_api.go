...
var spotify_users map[string]SpotifyUserSession = make(map[string]SpotifyUserSession)
...
func newSpotifySession(w http.ResponseWriter, r *http.Request) {
	...
	var newUser SpotifyUserSession
